...
} from "../../../main/database/free-queue/getAllCandidates";
...
export function Form(): JSX.Element {
  ...
  >(init);
  const [toInsert, dispatchOnInsert] = useReducer(reducer, init);
  ...
  const handleCancelClick = useCallback(() => {
    setCounter((c) => c + 10);
    resetPage();
    dispatchOnInsert({ mode: "CLEAR", candidates: List<FQCandidate>() });
